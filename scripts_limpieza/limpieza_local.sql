-- =============================================================================
--  LIMPIEZA DE DATOS - BASE DE DATOS EDEN (ENTORNO LOCAL)
--  Generado: 2026-08-21
--
--  Contenido:
...
--
--  IMPORTANTE:
--    - Ejecutar PRIMERO en local, verificar, y solo entonces usar limpieza_prod.sql
...
-- Esquema objetivo. La API usa la base `backupeden` (ver appsettings.json), tanto
-- en local como en el servidor de Railway. NO ejecutar sobre la base `railway`
-- (esa es la base vacía por defecto de Railway y NO tiene las tablas).
-- Si en tu servidor la base tiene otro nombre, cámbialo en la línea de abajo.
USE `backupeden`;
...
--
--    Esperado en LOCAL -> se borran ids: 8, 10, 12, 13, 18, 20, 21
--    Se conservan por tener referencias: 3, 7, 17
--
...
SELECT '--- Vet/Trab que quedan (solo deberían ser los referenciados: 3, 7, 17) ---' AS info;
